...
# Исправлен синтаксис скачивания
...
# Перенос создания скрипта вверх для лучшего кэширования слоев
...
# VOLUME декларация опущена вниз, чтобы не ломать кэш последующих шагов
VOLUME /pb/pb_data
